...
public record StatisticViewDto(
    ...
    public static StatisticViewDto of(
        ...
        return new StatisticViewDto(tilsCount, tilsMonthCount, receivedLikeCount, tilAlgorithmDto, leastValue, mostValue, analysisResult, aiRecommendDto);
    }
}
